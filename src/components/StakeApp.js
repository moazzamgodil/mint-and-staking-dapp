    ...
    const SliderNFTs = ({ align }) => {
        ...
        return (
            <div id="sliderNFTsAnimation">
                <StyledImg style={activeSlideImg == 0 ? { ...sliderDisplay, display: "block" } : { ...sliderDisplay, display: "none" }} src={`/config/images/0.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 1 ? { ...sliderDisplay, display: "block" } : { ...sliderDisplay, display: "none" }} src={`/config/images/1.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 2 ? { ...sliderDisplay, display: "block" } : { ...sliderDisplay, display: "none" }} src={`/config/images/2.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 3 ? { ...sliderDisplay, display: "block" } : { ...sliderDisplay, display: "none" }} src={`/config/images/3.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 4 ? { ...sliderDisplay, display: "block" } : { ...sliderDisplay, display: "none" }} src={`/config/images/4.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 5 ? { ...sliderDisplay, display: "block" } : { ...sliderDisplay, display: "none" }} src={`/config/images/5.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 6 ? { ...sliderDisplay, display: "block" } : { ...sliderDisplay, display: "none" }} src={`/config/images/6.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 7 ? { ...sliderDisplay, display: "block" } : { ...sliderDisplay, display: "none" }} src={`/config/images/7.png`} alt={"slideImage"} />
            </div>
        );
    }
        ...
        <>
            ...
            {!data.loggedIn || blockchain.smartContract === null ?
                ...
                <s.Container ai={"center"} flex={"1"} style={{ marginTop: "50px" }}>
                    ...
                    {data.loading && data.loggedIn ? (<><StyledGoldenText>Loading your NFTs</StyledGoldenText><img src="/config/images/loader.gif" alt="" /></>)
                        : (
                                    ...
                                    <div style={{ display: "flex", flexWrap: "wrap", padding: "20px" }}>
                                        {
                                            nftObj.map((nft, i) => (
                                                <div key={i}>
                                                    ...
                                                    ) : (<><StyledGoldenText>Loading your NFTs</StyledGoldenText><img src="/config/images/loader.gif" alt="" /></>)}
                                                </div>
                                            ))
                                        }
                                    </div>
