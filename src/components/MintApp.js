    ...
    const SliderNFTs = () => {
        return (
            <div id="sliderNFTsAnimation">
                <StyledImg style={activeSlideImg == 0 ? { display: "block" } : { display: "none" }} src={`/config/images/0.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 1 ? { display: "block" } : { display: "none" }} src={`/config/images/1.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 2 ? { display: "block" } : { display: "none" }} src={`/config/images/2.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 3 ? { display: "block" } : { display: "none" }} src={`/config/images/3.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 4 ? { display: "block" } : { display: "none" }} src={`/config/images/4.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 5 ? { display: "block" } : { display: "none" }} src={`/config/images/5.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 6 ? { display: "block" } : { display: "none" }} src={`/config/images/6.png`} alt={"slideImage"} />
                <StyledImg style={activeSlideImg == 7 ? { display: "block" } : { display: "none" }} src={`/config/images/7.png`} alt={"slideImage"} />
            </div>
        );
    }
